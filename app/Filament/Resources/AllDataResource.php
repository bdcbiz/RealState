        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('company_website')
                    ...
                    ->toggleable(),
                Tables\Columns\TextColumn::make('company_sales_person_ids')
                    ->label('Company Salespeople')
                    ->badge()
                    ->getStateUsing(function ($record) {
                        if (!$record->company_sales_person_ids) {
                            return [];
                        }
                        $ids = is_string($record->company_sales_person_ids)
                            ? json_decode($record->company_sales_person_ids, true)
                            : $record->company_sales_person_ids;
